...
def VIZ_AREA(df, x=None, y=None, color=None, facet_col=None, facet_row=None, markers=True):
    ...
    fig = px.area(data_frame=df, x=x, y=y, color=color, facet_col=facet_col, facet_row=facet_row)
    _fig(fig)
    return fig
...
def VIZ_BAR(df, x=None, y=None, color=None, facet_col=None, facet_row=None):
    '''Draw a bar plot'''
    x, y, color, facet_col, facet_row = (
        colHelper(df=df, columns=i, max=1, colsOnNone=False, forceReturnAsList=False) for i in [x, y, color, facet_col, facet_row])
    fig = px.histogram(data_frame=df, x=x, y=y, color=color, facet_col=facet_col, facet_row=facet_row)
    _fig(fig)
    return fig
...
def VIZ_BOX(df, x=None, y=None, color=None, facet_col=None, facet_row=None):
    '''Draw a box plot'''
    x, y, color, facet_col, facet_row = (
        colHelper(df=df, columns=i, max=1, colsOnNone=False, forceReturnAsList=False) for i in [x, y, color, facet_col, facet_row])
...
def VIZ_HIST(df, x=None, color=None, facet_col=None, facet_row=None):
    '''Draw a histogram'''
...
def VIZ_HIST_LIST(df, color=None):
    ...
    v = [px.histogram(data_frame=df, x=c, color=color) for c in df.columns]
    _fig(v)
    return v

def VIZ_ICICLE(df, path, values, root='All data', **kwargs):
    '''Draw a treemap plot'''
...
def VIZ_LINE(df, x=None, y=None, color=None, facet_col=None, facet_row=None, markers=True):
    '''Draw a line plot'''
    x, y, color, facet_col, facet_row = (
        colHelper(df=df, columns=i, max=1, colsOnNone=False, forceReturnAsList=False) for i in [x, y, color, facet_col, facet_row])
    fig = px.line(data_frame=df, x=x, y=y, color=color, facet_col=facet_col, facet_row=facet_row)
    _fig(fig)
    return fig
...
def VIZ_SCATTER(df, x=None, y=None, color=None, facet_col=None, facet_row=None, size=None): #symbol=None
    '''Draw a scatter plot'''
    x, y, color, facet_col, facet_row = (
        colHelper(df=df, columns=i, max=1, colsOnNone=False, forceReturnAsList=False) for i in [x, y, color, facet_col, facet_row])
    fig = px.scatter(data_frame=df, x=x, y=y, color=color, facet_col=facet_col, facet_row=facet_row)
    _fig(fig)
    return fig
...
def VIZ_SCATTERMATRIX(df, dimensions=None, color=None):
    ...
    fig = px.scatter_matrix(data_frame=df, dimensions=dimensions, color=color)
    _fig(fig)
    return fig

def VIZ_SUNBURST(df, path, values, root='All data', **kwargs):
    '''Draw a treemap plot'''
    path = [px.Constant("All data")] + colHelper(df=df, columns=path)
    values = colHelper(df=df, columns=values, max=1, type='number', forceReturnAsList=False)
    # treemap, icicle, sunburst break on NaN. Replace with 'None' for this call
    df1 = df.where(pd.notnull, None)
    try:
        fig = px.sunburst(data_frame=df1, path=path, values=values, 
                          #color_discrete_sequence=self._colorSwatch, 
                          **kwargs)
        fig.update_traces(root_color="lightgrey")
        fig.update_layout(margin = dict(t=50, l=25, r=25, b=25))
        _fig(fig)
...
def VIZ_TREEMAP(df, path, values, root='All data', **kwargs):
    '''Draw a treemap plot'''
    path = [px.Constant("All data")] + colHelper(df=df, columns=path)
    values = colHelper(df=df, columns=values, max=1, type='number', forceReturnAsList=False)
    # treemap, icicle, sunburst break on NaN. Replace with 'None' for this call
    df1 = df.where(pd.notnull, None)
    try:
        fig = px.treemap(data_frame=df1, path=path, values=values, 
                         #color_discrete_sequence=self._colorSwatch, 
                         **kwargs)
        fig.update_traces(root_color="lightgrey")
        fig.update_layout(margin = dict(t=50, l=25, r=25, b=25))
...
def VIZ_VIOLIN(df, x=None, y=None, color=None, facet_col=None, facet_row=None):
    '''Draw a violin plot'''
    x, y, color, facet_col, facet_row = (
        colHelper(df=df, columns=i, max=1, colsOnNone=False, forceReturnAsList=False) for i in [x, y, color, facet_col, facet_row])
