...
| --- | --- | ---
| ```DF_COL_ADD_FIXED``` | Add a new column with a 'fixed' value as content  ```.DF_COL_ADD_FIXED('Tokyo')``` ```.DF_COL_ADD_FIXED('Tokyo', 'City')``` | ```.DF_COL_ADD_FIXED('Tokyo')``` ```.DF_COL_ADD_FIXED('Tokyo', 'City')```  
